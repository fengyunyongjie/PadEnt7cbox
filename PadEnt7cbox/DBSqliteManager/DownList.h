...
#define InsertDownList @"INSERT INTO DownList(d_name,d_state,d_thumbUrl,d_baseUrl,d_file_id,d_downSize,d_datetime,d_ure_id,Is_Onece) VALUES (?,?,?,?,?,?,?,?,?)"
#define InsertsDownLists @"INSERT INTO DownList(d_name,d_state,d_thumbUrl,d_baseUrl,d_file_id,d_downSize,d_datetime,d_ure_id,Is_Onece) VALUES ('%@',%i,'%@','%@','%@',%i,'%@','%@',%i);"
#define DeleteDownList @"DELETE FROM DownList WHERE d_id=? and d_ure_id=?"
#define DeleteDownLists @"DELETE FROM DownList WHERE d_id=%i and d_ure_id='%@';"
...
#define UpdateDownListForUserId @"UPDATE DownList SET Is_Onece=?,d_state=?,d_baseUrl=?,d_file_id=?,d_downSize=?,d_datetime=? WHERE d_id=? and d_ure_id=?"
#define UpdateDownListForState @"UPDATE DownList SET Is_Onece=?,d_baseUrl=?,d_file_id=?,d_downSize=?,d_datetime=? WHERE d_state=? and d_name=? and d_ure_id=?"
